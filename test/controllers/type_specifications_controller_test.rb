...
class TypeSpecificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_specification" do
    assert_difference("TypeSpecification.count") do
      post type_specifications_url, params: { type_specification: { specification_id: @type_specification.specification_id, type_id: @type_specification.type_id } }, as: :json
    end
  ...
  test "should update type_specification" do
    patch type_specification_url(@type_specification), params: { type_specification: { specification_id: @type_specification.specification_id, type_id: @type_specification.type_id } }, as: :json
    assert_response :success
  end
